...
I love solving real-world problems with code and exploring new technologies every day.
...
| ----------------- | -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------------------------- |
| **Grand Hotel**   | Find your perfect stay with comfort, convenience, and charm.                                             | <a href="https://grandhotel-ynab.onrender.com" target="_blank">Live</a> | [GitHub](https://github.com/adadarsh23/Grand-Hotel-Mern) |
| **Ai Chat**   |A full-featured AI Chat Application built using modern web technologies.                              | <a href="https://aichat3.netlify.app/" target="_blank">Live</a> | [GitHub](https://github.com/adadarsh23/Ai-Chat) |
...
Here’s what I love plugging into my projects:

- 🔐 **Firebase** – Auth, hosting, and Firestore for real-time data
- 🌐 **Giphy API** – For real-time GIF search & display
- 📰 **News APIs** – For breaking headlines (used in **SachNews**)
- 🎨 **Font Awesome + React Icons** – For clean, scalable visuals

> ⚠️ API keys & secrets are managed securely with `.env` configs

---

## 🌱 Currently Learning

- ⚡ Advanced patterns in **React + Node**
- 🔌 Real-time features with **WebSockets**
- 🔎 GraphQL for efficient data fetching
- 💡 Planning to launch my own **SaaS product** by 2026
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-adadarsh23-0077B5?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/adadarsh23)  
